...
if len(argv) < 2:
    print("[ERROR] Missing arguments! See '-h' for more info.")
    exit(1)

elif "-h" in argv or "--help" in argv:
    print(f"Usage: {argv[0]} key_file < text_file")
    exit(0)

if stdin.isatty():
    print("[ERROR] Must provide data to encrypt via STDIN. See '-h' for more info.")
    exit(1)
